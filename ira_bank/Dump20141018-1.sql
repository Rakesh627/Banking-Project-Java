...
CREATE TABLE `account_details` (
  ...
  CONSTRAINT `USER_ID` FOREIGN KEY (`U_ID`) REFERENCES `users` (`USER_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `notification_details` (
  ...
  CONSTRAINT `NOTIFICATION_USER_ID` FOREIGN KEY (`NOTIFICATION_USER_ID`) REFERENCES `users` (`USER_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `PKI_PATH` varchar(45) NOT NULL,
  `PKI_CERTI` varchar(45) NOT NULL,
  `PKI_NUMBER` varchar(45) NOT NULL,
...
INSERT INTO `users` VALUES (7,'moder','moder','mod@gmail.com','2014-09-17 00:11:35','','','','0000-00-00','','','','','','','','',NULL,NULL),(8,'admin','admin','admin@gmail.com','2014-09-17 00:11:35','','','','0000-00-00','','','','','','','','',NULL,NULL);
...
-- Dump completed on 2014-10-18  0:44:33
